...
The available config fields are listed below. The system property ``basedir`` is available as a substiution value. It
holds the absolute path value to the node's base directory.
